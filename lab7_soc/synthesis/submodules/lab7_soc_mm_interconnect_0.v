...
// 
// Generated using ACDS version 14.0 200 at 2015.03.11.20:24:14
...
module lab7_soc_mm_interconnect_0 (
	...
	wire    [8:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sdram_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> sysid_qsys_0_control_slave_agent:cp_channel
	...
	wire  [106:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> led_s1_agent:cp_data
	wire    [8:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> led_s1_agent:cp_channel
	...
	wire          key_2_s1_agent_rdata_fifo_src_valid;                                                // key_2_s1_agent:rdata_fifo_src_valid -> key_2_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] key_2_s1_agent_rdata_fifo_src_data;                                                 // key_2_s1_agent:rdata_fifo_src_data -> key_2_s1_agent:rdata_fifo_sink_data
	wire          key_2_s1_agent_rdata_fifo_src_ready;                                                // key_2_s1_agent:rdata_fifo_sink_ready -> key_2_s1_agent:rdata_fifo_src_ready
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> key_2_s1_agent:cp_endofpacket
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> key_2_s1_agent:cp_valid
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> key_2_s1_agent:cp_startofpacket
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> key_2_s1_agent:cp_data
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> key_2_s1_agent:cp_channel
	wire          cmd_mux_007_src_ready;                                                              // key_2_s1_agent:cp_ready -> cmd_mux_007:src_ready
	...
	wire          key_3_s1_agent_rdata_fifo_src_valid;                                                // key_3_s1_agent:rdata_fifo_src_valid -> key_3_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] key_3_s1_agent_rdata_fifo_src_data;                                                 // key_3_s1_agent:rdata_fifo_src_data -> key_3_s1_agent:rdata_fifo_sink_data
	wire          key_3_s1_agent_rdata_fifo_src_ready;                                                // key_3_s1_agent:rdata_fifo_sink_ready -> key_3_s1_agent:rdata_fifo_src_ready
	wire          cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> key_3_s1_agent:cp_endofpacket
	wire          cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> key_3_s1_agent:cp_valid
	wire          cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> key_3_s1_agent:cp_startofpacket
	wire  [106:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> key_3_s1_agent:cp_data
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> key_3_s1_agent:cp_channel
	wire          cmd_mux_008_src_ready;                                                              // key_3_s1_agent:cp_ready -> cmd_mux_008:src_ready
	...
	wire  [106:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_007:sink_data
	...
	wire          key_2_s1_agent_rp_endofpacket;                                                      // key_2_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	wire          key_2_s1_agent_rp_valid;                                                            // key_2_s1_agent:rp_valid -> router_009:sink_valid
	wire          key_2_s1_agent_rp_startofpacket;                                                    // key_2_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire  [106:0] key_2_s1_agent_rp_data;                                                             // key_2_s1_agent:rp_data -> router_009:sink_data
	wire          key_2_s1_agent_rp_ready;                                                            // router_009:sink_ready -> key_2_s1_agent:rp_ready
	...
	wire          key_3_s1_agent_rp_endofpacket;                                                      // key_3_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	wire          key_3_s1_agent_rp_valid;                                                            // key_3_s1_agent:rp_valid -> router_010:sink_valid
	wire          key_3_s1_agent_rp_startofpacket;                                                    // key_3_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire  [106:0] key_3_s1_agent_rp_data;                                                             // key_3_s1_agent:rp_data -> router_010:sink_data
	wire          key_3_s1_agent_rp_ready;                                                            // router_010:sink_ready -> key_3_s1_agent:rp_ready
	...
	wire    [8:0] cmd_demux_src2_channel;                                                             // cmd_demux:src2_channel -> crosser:in_channel
	...
	wire    [8:0] crosser_out_channel;                                                                // crosser:out_channel -> cmd_mux_002:sink0_channel
	...
	wire    [8:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_002:sink1_channel
	...
	wire    [8:0] rsp_demux_002_src0_channel;                                                         // rsp_demux_002:src0_channel -> crosser_002:in_channel
	...
	wire    [8:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink2_channel
	...
	wire    [8:0] rsp_demux_002_src1_channel;                                                         // rsp_demux_002:src1_channel -> crosser_003:in_channel
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (key_2_s1_agent_rdata_fifo_src_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (key_2_s1_agent_rdata_fifo_src_valid),              //                .valid
		.rdata_fifo_sink_data    (key_2_s1_agent_rdata_fifo_src_data),               //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (key_3_s1_agent_rdata_fifo_src_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (key_3_s1_agent_rdata_fifo_src_valid),              //                .valid
		.rdata_fifo_sink_data    (key_3_s1_agent_rdata_fifo_src_data),               //                .data
